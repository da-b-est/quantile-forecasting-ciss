...
# -*- coding: utf-8 -*-
"""
Created on Sun Jan  5 21:02:32 2025
...
#Expected Shortfall and Longrise (One-Year Ahead)
...
ax.set_title('Score of the Predictions Over Time - CISS + GDP + SPF Forecast (Mean) (YoY) ')
...
# Setting plot title, labels, and legend
ax.set_title('Score of the Predictions Over Time - CISS + GDP + SPF Forecast (Median) (YoY) ')
ax.set_ylabel('Score f(y)')
ax.set_xlabel('Time')
ax.set_ylim([-0.05, 0.35])
ax.legend()
